...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#181818', color: '#71717a', borderColor: 'rgba(255, 255, 255, 0.12)' },
          active: { scale: 1.1, backgroundColor: '#10b981', color: '#ffffff', borderColor: '#10b981', boxShadow: '0 0 15px rgba(16, 185, 129, 0.6)' },
          complete: { scale: 1, backgroundColor: '#10b981', color: '#ffffff', borderColor: '#10b981' }
        }}
