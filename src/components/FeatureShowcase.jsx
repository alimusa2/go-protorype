    ...
    <section id="what-we-offer" className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#0d0d0d] overflow-clip">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start relative">
          ...
          {/* Right Column: Premium React Bits Stepper Container */}
                    ...
                    <div className="space-y-4 py-2">
                      ...
                      <div className="flex items-center justify-between flex-wrap gap-2">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-mono font-bold tracking-widest px-2.5 py-0.5 rounded-full uppercase text-emerald-300 bg-emerald-950 border border-emerald-500/60">
                            {door.doorNumber}
                          </span>
